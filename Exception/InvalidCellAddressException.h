...
private:
    ...
    const char *_message;
public:
    explicit InvalidCellAddressException(INDEX_T lineNumber = 0, INDEX_T columnNumber = 0, std::string value = "", const char *message = "") : _value(std::move(value)), _message(message), _lineNumber(lineNumber), _columnNumber(columnNumber) { }
